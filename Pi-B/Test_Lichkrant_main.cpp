// //++ -std=c++17 Test_Lichkrant_main.cpp $(ls *.cpp | grep -v main.cpp) -o Licht_krant_test
// #include "globals.h"
...
//     const char* message = "text:Krilling myself:\n";
...
//     // Connect to Pi-A
//     PiConnection piConn;
//     piConn.connectToPi(pi_a_ip, PI_A_PORT);
...
//                 if (sock > 0) {
//                     Socket[i] = sock;
//                     printf("Connected to Wemos[%d], socket = %d\n", i, sock);
//                 } else {
...
//             } else {
//                 printf("Socket[%d] is invalid, skipping...\n", j);
//             }
//         }
